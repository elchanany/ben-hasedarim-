...
import {
    ISRAELI_CITIES, JOB_DIFFICULTY_FILTER_OPTIONS, DATE_TYPE_FILTER_OPTIONS,
    PAYMENT_KIND_OPTIONS, PAYMENT_METHOD_FILTER_OPTIONS, DURATION_FLEXIBILITY_OPTIONS, SUITABILITY_FOR_OPTIONS
} from '../constants';
            ...
            <form onSubmit={(e) => { e.preventDefault(); handleSaveAlert(); }} className="space-y-6">
                ...
                <fieldset className="p-4 border border-gray-200 rounded-md">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <Select label="זמינות העבודה" name="dateType" options={DATE_TYPE_FILTER_OPTIONS} value={alertFormData.dateType || ''} onChange={handleAlertFormChange} />
                    </div>
