      ...
      <form onSubmit={handleSubmit} className="space-y-6" noValidate>
        ...
        <fieldset className="p-4 border border-gray-200 rounded-md">
            ...
            {formData.contactInfoSource === 'currentUser' && user && (
                 <div className="mt-3 p-3 border rounded-md bg-gray-50 animate-fade-in-down">
             ...
             {formData.contactInfoSource === 'anonymous' && (
                <div className="space-y-4 mt-3 p-3 border rounded-md bg-gray-50 animate-fade-in-down">
        ...
        <div className="bg-gray-50 border border-gray-300 p-4 rounded-md mt-6 mb-4 flex items-start text-gray-700 shadow-sm">
            <LightBulbIcon className="w-7 h-7 ml-3 rtl:mr-3 rtl:ml-0 text-gray-600 flex-shrink-0 mt-0.5" />
            <p className="text-sm">
