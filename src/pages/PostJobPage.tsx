...
import { getTodayGregorianISO, gregSourceToHebrewString, formatGregorianString, formatDateByPreference } from '../utils/dateConverter';
...
export const PostJobPage: React.FC<PageProps> = ({ setCurrentPage, pageParams }) => {
  ...
  const todayLabelFormatted = formatDateByPreference(today, authCtx?.datePreference || 'hebrew');
  const dateTypeOptions = [
      { value: 'today', label: `להיום (${todayLabelFormatted})`},
