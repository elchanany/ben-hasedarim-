...
export const HomePage: React.FC<PageProps> = ({ setCurrentPage }) => {
  ...
  const [displayLimit, setDisplayLimit] = useState(INITIAL_JOBS_DISPLAY_COUNT);
  ...
  const filterFormContent = (
    <form onSubmit={handleHomeSearchSubmit} className="space-y-2 md:space-y-6" noValidate>
