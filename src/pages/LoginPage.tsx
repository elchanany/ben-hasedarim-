  ...
  return (
    <div className="min-h-[calc(100vh-250px)] flex flex-col items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8 bg-white p-8 sm:p-10 rounded-xl shadow-2xl">
        ...
        {message && <p className="text-center text-sm text-blue-700 bg-blue-100 p-3 rounded-md" role="status">{message}</p>}
        {error && <p id="login-error-summary" className="text-center text-sm text-red-700 bg-red-100 p-3 rounded-md" role="alert" aria-live="assertive">{error}</p>}
