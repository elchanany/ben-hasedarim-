  ...
  return (
    ...
    >
      ...
      <div className="p-2 pb-1">
        ...
        {/* פרטי העבודה */}
        <div className="mb-2 p-2 bg-light-pink rounded-lg">
          {/* פרטים חשובים - גדולים */}
        ...
        {/* תיאור העבודה */}
        <div className="mb-2 p-2 bg-yellow-50 rounded-lg flex-grow">
      ...
      <div className="mt-auto"> {/* This div wraps owner actions and below */}
        {isOwner && (
          <div className="px-2 pt-1.5 pb-1.5 flex justify-between items-center border-t border-gray-200 bg-light-pink">
            <Button
              variant="outline"
              size="sm"
