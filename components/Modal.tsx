...
export const Modal: React.FC<ModalProps> = ({ isOpen, onClose, title, children, size = 'md', panelClassName, titleId = "modal-title", headerActions }) => {
  ...
  return createPortal(
    <div
      className="fixed inset-0 z-[100] bg-black bg-opacity-50 backdrop-blur-sm flex items-center justify-center p-4 transition-opacity duration-300 ease-in-out overflow-y-auto"
      onClick={onClose}
      role="dialog"
      aria-modal="true"
    ...
    >
      ...
      >
        {title && (
          <div className="flex-shrink-0 flex justify-between items-center p-4 sm:p-6 border-b border-gray-200 bg-gray-50">
