...
export const Input: React.FC<InputProps> = ({
  ...
  const baseInputStyle =
    'mt-1 block w-full px-3 py-2 bg-light-blue/10 border border-light-blue/30 rounded-md shadow-sm focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-1 focus-visible:ring-focus-ring-color focus:border-royal-blue sm:text-sm text-dark-text placeholder-medium-text disabled:bg-light-pink/20 disabled:cursor-not-allowed';
