...
export const Select: React.FC<SelectProps> = ({
  ...
  const baseSelectStyle =
    'mt-1 block w-full pl-3 pr-10 py-2 text-base bg-light-blue/10 border border-light-blue/30 focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-1 focus-visible:ring-focus-ring-color focus:border-royal-blue sm:text-sm text-dark-text rounded-md disabled:bg-light-pink/20';
